...
### Real-Time Motorcycle Helmet Detection using YOLOv8 + ResNet50

[![Live Demo](https://img.shields.io/badge/🤗%20Live%20Demo-Hugging%20Face-FFD21E?style=for-the-badge)](https://huggingface.co/spaces/Maliktg5/Smart_Helmet_Detection_Systemt)
[![Open In Colab](https://img.shields.io/badge/Open%20In-Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/drive/15uGyd72UBFkgHZAtbmllrVtsFPxPCbt_?usp=sharing)
...
[![YOLOv8](https://img.shields.io/badge/YOLOv8-Ultralytics-00ADEF?style=for-the-badge)](https://ultralytics.com)

<br/>

> A two-model AI pipeline that detects motorcycle riders and automatically
> classifies whether each rider is wearing a helmet — in real time, on images and videos.
...
This system solves a real-world **road safety problem**: automatically detecting
whether motorcycle riders are wearing helmets from any image or video feed.
...
> Threshold was **not hardcoded at 0.5** — it was automatically found by scanning
> thresholds from 0.20 → 0.80 and selecting the one with the highest macro F1-score.
...
```bash
# Clone the repo
git clone https://github.com/Maliktg5/smart-helmet-detection
...
> Videos are automatically resized to **640px width** before processing
> to maximize speed on CPU-only Hugging Face Spaces.
